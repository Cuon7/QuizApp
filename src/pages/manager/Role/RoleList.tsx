...
function RoleList() {
    const [data, setData] = useState<RoleViewModel[]>([]);
    ...
    const [columns] = useState<TableColumnModel[]>([
        { field: 'name', label: 'Name', iconASC: faSortAlphaAsc, iconDESC: faSortAlphaDesc, isEnum: false, enum: null, sortabled: false, },
        { field: 'description', label: 'Description', iconASC: faSortAlphaAsc, iconDESC: faSortAlphaDesc, isEnum: false, enum: null, sortabled: false },
